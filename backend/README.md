...
This project contains source code and supporting files for the serverless application deployed with the SAM CLI. It includes the following files and folders.

- get_function - Code for the application's Lambda function.
